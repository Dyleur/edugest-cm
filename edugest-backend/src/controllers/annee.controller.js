...
const getAllAnnees = async (req, res) => {
  try {
    ...
    res.status(200).json({ success: true, data: annees });
  } catch (error) {
    res.status(500).json({ success: false, message: error.message });
  }
};

const getAnneeCourante = async (req, res) => {
  try {
    const annee = await anneeService.getAnneeCourante();
...
const getAnneeById = async (req, res) => {
  try {
    ...
    res.status(200).json({ success: true, data: annee });
  } catch (error) {
    res.status(404).json({ success: false, message: error.message });
  }
};
...
const createAnnee = async (req, res) => {
  try {
    ...
    res.status(201).json({ success: true, message: 'Année scolaire créée avec succès', data: annee });
  } catch (error) {
    res.status(500).json({ success: false, message: error.message });
  }
};
...
const updateAnnee = async (req, res) => {
  try {
    ...
    res.status(200).json({ success: true, message: 'Année scolaire modifiée avec succès', data: annee });
  } catch (error) {
    res.status(500).json({ success: false, message: error.message });
  }
};
